...
import { FONT_STYLE } from '../config/game'
...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('bullet', './src/assets/img/bullet.png')
    this.load.image('ship', './src/assets/img/ship.png')
    this.load.image('sky', './src/assets/img/bg.jpg')
  }
  create() {
